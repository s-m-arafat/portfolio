...
export default function FloatingNarrationPlayer() {
  ...
  return (
    <div className="fixed bottom-2 sm:bottom-6 left-2 sm:left-4 right-2 sm:right-4 z-50 animate-in slide-in-from-bottom-4 duration-300">
      <div className="max-w-5xl mx-auto bg-gradient-to-r from-amber-100 via-orange-100 to-amber-100 border-2 border-amber-300 rounded-xl sm:rounded-2xl shadow-2xl backdrop-blur-sm">
        <div className="px-2 sm:px-4 py-2 sm:py-2.5">
          <div className="flex items-center gap-2 sm:gap-3">
            {/* Story Info */}
            <button
              onClick={goToStory}
              className="flex items-center gap-1.5 sm:gap-2 hover:opacity-80 transition-opacity min-w-0 flex-shrink"
            >
              <div className="w-8 h-8 sm:w-9 sm:h-9 bg-amber-500 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex justify-between mt-0.5">
              <span className="text-[9px] sm:text-[10px] text-gray-600">{formatTime(currentTime)}</span>
              <span className="text-[9px] sm:text-[10px] text-gray-600">{formatTime(duration)}</span>
            </div>
          </div>
            ...
            >
              ...
              {/* Speed Control */}
              <div className="relative pl-1 sm:pl-1.5 border-l border-amber-300" ref={speedMenuRef}>
              <button
              ...
              >
                ...
                <span className="hidden xs:inline">{`${Number.isInteger(playbackRate) ? playbackRate.toFixed(0) : playbackRate}x`}</span>
              </button>
              ...
              <button
              onClick={goToStory}
              className="p-1.5 hover:bg-amber-200 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-amber-400 ml-0.5 sm:ml-1 border-l border-amber-300 pl-2 sm:pl-2.5"
