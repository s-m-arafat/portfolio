  ...
  return (
    <div className="relative min-h-screen">
      ...
      <section className="relative px-5 lg:px-10 py-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex items-center mb-6">
            <Briefcase className="text-title mr-3" size={24} />
            <h2 className="text-2xl font-bold text-title">{Experience.name}</h2>
          </div>
      ...
      <section className="relative px-5 lg:px-10 py-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex items-center mb-6">
            <GraduationCap className="text-title mr-3" size={24} />
            <h2 className="text-2xl font-bold text-title">{Education.name}</h2>
          </div>
      ...
      <section className="relative px-5 lg:px-10 py-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex items-center mb-6">
            <Code className="text-title mr-3" size={24} />
            <h2 className="text-2xl font-bold text-title">{Skills.name}</h2>
          </div>
      ...
      <section className="relative px-5 lg:px-10 py-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-title">{Projects.name}</h2>
          </div>
