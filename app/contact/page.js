            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 bg-white/5 border border-cyan-800/20 rounded-lg text-cyan-300 placeholder-cyan-600 focus:outline-none focus:border-cyan-500/50"
              ...
              <div>
                ...
                <textarea
                  rows={6}
                  className="w-full px-4 py-3 bg-white/5 border border-cyan-800/20 rounded-lg text-cyan-300 placeholder-cyan-600 focus:outline-none focus:border-cyan-500/50 resize-none"
