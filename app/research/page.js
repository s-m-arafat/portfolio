  ...
  return (
    <div className="relative min-h-screen">
      ...
      <section className="relative px-5 lg:px-10 py-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex items-center mb-6">
            <Award className="text-title mr-3" size={24} />
            <h2 className="text-2xl font-bold text-title">Research Areas</h2>
          </div>
      ...
      <section className="relative px-5 lg:px-10 py-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex items-center mb-6">
            <BookOpen className="text-title mr-3" size={24} />
            <h2 className="text-2xl font-bold text-title">Publications</h2>
          </div>
